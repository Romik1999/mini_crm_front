...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/lo1J0YJnK6)
...
```sh
npx nx serve mini_crm_front
```

To create a production bundle:

```sh
npx nx build mini_crm_front
```

To see all available targets to run for a project, run:

```sh
npx nx show project mini_crm_front
```
